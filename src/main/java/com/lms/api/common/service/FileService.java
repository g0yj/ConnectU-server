        ...
        files.stream()
                ...
                .forEach(file -> {
                    ...
                    if (file.getSize() > getMaxFileSize()) {
                        throw new AppException(AppErrorCode.FILE_SIZE_EXCEEDED, maxFileSizeStr, file.getOriginalFilename());
                    }
    ...
    public String upload(MultipartFile file) {
        ...
        if (!dir.exists()) {
            if (!dir.mkdirs()) {  // 디렉토리 생성 실패 시 예외 발생
                throw new AppException(AppErrorCode.FILE_UPLOAD_ERROR, "Failed to create upload directory");
            }
        }
        ...
        try {
            ...
            throw new AppException(AppErrorCode.FILE_UPLOAD_ERROR, e);
        }
    }
