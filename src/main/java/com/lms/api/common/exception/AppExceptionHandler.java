...
public class AppExceptionHandler {
  ...
  public ResponseEntity<AppErrorResponse> handleMaxSizeException(
    ...
    String errorMessage = String.format(AppErrorCode.FILE_SIZE_EXCEEDED.getMessage(), maxFileSizeStr,
        exceededFileSize);
    return ResponseEntity.status(HttpStatus.BAD_REQUEST)
        .body(AppErrorResponse.builder()
            .code(AppErrorCode.FILE_SIZE_EXCEEDED.getCode())
            .message(errorMessage)
            .build());
  }

  @ExceptionHandler(AppException.class)
  public ResponseEntity<AppErrorResponse> handleLmsException(AppException e) {
